...
public abstract class LoopManiaWorldLoader {
    ...
    private void loadEntity(LoopManiaWorld world, JSONObject currentJson, List<Pair<Integer, Integer>> orderedPath) {
        ...
        switch (type) {
            case "hero_castle":
                ...
                character = new Character(new PathPosition(indexInPath, orderedPath));
                world.setCharacter(character);
                character.setWorld(world);
                onLoad(character);
                character.registerObserver(heroCastle);
                entity = character;
                break;
            case "vampire_castle":
                VampireCastleBuilding vampireCastleBuilding = new VampireCastleBuilding(new SimpleIntegerProperty(x),
                ...
                character.registerObserver(vampireCastleBuilding);
                break;
            case "zombie_pit":
                ...
                character = world.getCharacter();
                character.registerObserver(zombiePitBuilding);
                break;
            case "path_tile":
    ...
    public abstract void onLoad(VampireCastleBuilding vampireCastleBuilding);

    public abstract void onLoad(ZombiePitBuilding zombiePitBuilding);
